...
export function SettingsView() {
  ...
  const permissionStatusNote = hasPermissionCheckError
    ? "macOS の権限状態を読み取れませんでした。自分トラックの録音・文字起こしや相手側音声取得の可否が不明なため、システム設定のプライバシーとセキュリティでマイクと画面収録を確認してください。"
    : "マイクは自分トラックの録音、画面収録は相手側音声の取得に必要です。拒否または未確認の場合はシステム設定のプライバシーとセキュリティで確認してください。";
